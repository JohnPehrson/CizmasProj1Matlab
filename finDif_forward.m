function [findifnumber] = finDif_forward(XORY,Ind_i,Ind_j,delta_z,delta_n,switchnumber)
...
%or n with 2
    ...
    if switchnumber ==1 %z derivative
        findifnumber = (XORY(Ind_i+1,Ind_j)-XORY(Ind_i,Ind_j))/delta_z;
    elseif switchnumber ==2 %n derivative
        findifnumber = (XORY(Ind_i,Ind_j+1)-XORY(Ind_i,Ind_j))/delta_n;
    else
